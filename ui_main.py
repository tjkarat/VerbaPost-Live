...
def render_legal_page():
    ...
    with tab_tos:
        with st.container(border=True):
            ...
            st.write("You agree NOT to use VerbaPost to send threatening or illegal content.")
    with tab_privacy:
        with st.container(border=True):
...
def show_main_app():
    ...
    # --- WORKSPACE ---
        ...
        with st.container(border=True):
            ...
            if "Civic" in tier:
                st.info("🏛️ **Civic Mode:** We auto-detect reps.")
    ...
    # --- REVIEW ---
        ...
        if st.button("🚀 Send Letter", type="primary"):
            ...
            pdf = letter_format.create_pdf(txt, to_s, from_s, False, "English")
