...
def inject_seo():
    ...
    # We write this directly to the static folder to ensure it exists.
...
"""
    ...
    # (Matches your updated messaging)
    seo_html_content = """
    ...
    if os.path.exists(index_path):
        ...
        if "id=\"seo-content\"" not in html:
            ...
            with open(index_path, "w", encoding="utf-8") as f:
                f.write(new_html)
            print("✅ SEO Injection Complete: Meta tags added.")
