...
# --- EMBEDDED LOGOS (Base64 SVGs) ---
# These are embedded directly to prevent broken links or CORS errors.

# Stripe (Blurple)
STRIPE_SVG = "data:image/svg+xml;base64,"

# Twilio (Red Circle)
TWILIO_SVG = "data:image/svg+xml;base64,"

# OpenAI (Black)
OPENAI_SVG = "data:image/svg+xml;base64,"

# Supabase (Emerald Green)
SUPABASE_SVG = "data:image/svg+xml;base64,"

# USPS (Eagle Blue)
USPS_SVG = "data:image/svg+xml;base64,"
...
def render_splash_page():
    ...
    /* Hover Effect */
    .trust-logo { opacity: 0.6; transition: opacity 0.3s; }
    .trust-logo:hover { opacity: 1.0; }
    ...
    # --- TRUST BADGES (Using Embedded Images) ---
    st.markdown("""
    ...
    <div class="trust-container">
        <img class="trust-logo" src="{}" style="height: 28px;" title="Stripe">
        <img class="trust-logo" src="{}" style="height: 32px;" title="Twilio">
        <img class="trust-logo" src="{}" style="height: 28px;" title="OpenAI">
        <img class="trust-logo" src="{}" style="height: 28px;" title="Supabase">
        <img class="trust-logo" src="{}" style="height: 32px;" title="USPS">
    </div>
    """.format(STRIPE_SVG, TWILIO_SVG, OPENAI_SVG, SUPABASE_SVG, USPS_SVG), unsafe_allow_html=True)

    # --- SECONDARY OPTION (STORE) ---
