...
st.markdown(f"""
    ...
    /* SECONDARY Buttons (Sidebar, Cancel, etc) - WHITE */
    /* We use :not(:disabled) to avoid breaking disabled states */
    div.stButton > button {{
        background-color: #ffffff; 
        color: #31333F;
    ...
    /* PRIMARY Buttons (Login, Pay, Send) - BLUE */
    /* We increase specificity to override the white rule above */
    div.stButton > button[kind="primary"] {{
        background-color: #2a5298 !important;
        color: #FFFFFF !important;
        border: none !important;
    }}
    /* Force internal text to be white */
...
with st.sidebar:
    ...
    # REMOVED LEGAL BUTTON FROM SIDEBAR HERE

# ... (Keep all existing code above the 'ROUTING' section) ...
